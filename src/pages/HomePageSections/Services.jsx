    ...
    <div data-aos="fade-up" className="mt-10 sm:mt-20">
      ...
      <div className="gap-4 flex flex-col items-center adjustedwidth mx-auto">
        ...
        <h3 className="text-sechead sm:max-w-[60%] text-center leading-tight">
          Delivering Cutting-Edge, Custom Technology Solutions
        </h3>
        <p className="max-w-[70%] text-center text-desc">
          Our expertise lies in providing innovative technology solutions that
          streamline business processes, enhance productivity, and accelerate
          ...
          {firstNineServices.map((obj, index) => {
            ...
            return (
              <div
                ...
                key={obj.id}
                className="relative bg-white group  hover:bg-gradient-to-b from-[#1a1188]/50 to-[#3d3789] h-full   rounded overflow-hidden shadow-lg border border-slate-100 flex justify-center items-center"
              >
                ...
                <div className="flex flex-col p-4 aspect-auto justify-between min-h-full text-center items-center">
                  ...
                  <h2 className="text-head font-bold text-center group-hover:text-white">
                    {obj.title}
                  </h2>
                  <p className="text-desc group-hover:text-white">
                    {obj.paragraph}
                  </p>
                  <Link
                    to={"/services"}
                    // onClick={() => handleSelectServiceToShowDetail(obj)}
                    className="flex text-[17px] mt-2 group-hover:text-white group-hover:border-white items-center border-b border-black text-black w-[6.13rem] "
                  >
