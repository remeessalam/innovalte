        ...
        <div className="flex flex-col gap-4 lg:w-[45%] w-full">
          ...
          <div data-aos="fade-up" className="flex gap-4">
            ...
            <div className="flex flex-col pt-3">
              ...
              <p className="text-desc">
                To empower businesses with tailored technology solutions that
                drive operational excellence, sustainable growth, and long-term
                success.
              </p>
            </div>
          </div>
          <div data-aos="fade-up" className="flex gap-4">
            ...
            <div className="flex flex-col pt-3">
              ...
              <p className="text-desc">
                To be a global leader in digital innovation, leveraging emerging
                technologies to create scalable, future-ready solutions that
                drive success.
              </p>
            </div>
          </div>
