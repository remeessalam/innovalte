      ...
      <div className="adjustedwidth mx-auto flex md:flex-row flex-col-reverse justify-between">
        ...
        <div className="w-full md:w-[48%]">
          ...
          <p data-aos="fade-left" className="text-desc">
            ...
            innovative spirit. We specialize in a broad range of technology
            services tailored to meet the ever-changing needs of our clients.
            From groundbreaking Artificial Intelligence solutions that transform
