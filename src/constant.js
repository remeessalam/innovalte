...
export const ourServices = [
  ...
  },
  {
    ...
    image: scloudmigrationimage, // Replace with actual image import
    title: "Cloud Migration Services",
    description:
      "Migrating to the cloud can be a complex process, but with the right strategy, it offers numerous benefits. Our cloud migration services help businesses smoothly transition from legacy systems to modern cloud environments. We assess your infrastructure, develop a migration plan, and ensure that your data, applications, and workflows are securely moved to the cloud with minimal disruption.",
    paragraph:
      "We make cloud migration simple and seamless, helping your business scale with ease.",
  },
  {
    id: 15,
    img: nlpimage, // Replace with actual image import
    image: snlpimage, // Replace with actual image import
    title: "Natural Language Processing (NLP)",
    description:
      "Natural Language Processing (NLP) empowers computers to understand, interpret, and respond to human language. Our NLP services enable you to build intelligent applications that engage users more effectively, from chatbots and sentiment analysis to language translation systems. By integrating NLP into your business processes, you can improve user interactions, gain valuable insights, and automate language-based tasks.",
    paragraph:
      "Transform the way your business communicates and interacts with NLP solutions.",
  },
];
export const routes = [
  { path: "/", name: "home" },
...
export const teamMembers = [
  { id: 1, name: "Brooklyn Simmons", position: "Developer" },
  { id: 2, name: "Guy Hawkins", position: "UI/UX Developer" },
...
export const faqItems = [
  ...
  },
  {
    ...
    answer:
      "The timeline varies based on project complexity. We work efficiently to meet deadlines while ensuring high-quality deliverables. Contact us to discuss your project timeline.",
  },
  {
    id: 4,
    question: "Do you offer post-launch support?",
    answer:
      "Yes, we provide ongoing maintenance and support to ensure your software or platform runs smoothly after deployment.",
  },
  {
    id: 5,
    question: "Can I request a custom solution for my business?",
    answer:
      "Absolutely! We tailor our services to fit your specific business needs. Contact us to discuss your requirements.",
  },
];
